...
const SHEET_NAMES = {
  ...
  let MAINTENANCE_CYCLES = {
    ...
    'REPLACE_FIRE_EXTINGUISHER': { category: '本体更新', years: 10, label: '消火器更新', searchKey: '消火器', suffix: 'FIRE-EXT-01', seasonal: true, alertMonth: 1, alertDay: 1 },
    ...
    'FIELD_LIGHT':      { category: '美観', years: 20, label: 'フィールド照明灯', searchKey: 'フィールド', suffix: 'FIELD-L-01' },
    ...
    'MAINT_WELL_5Y':       { category: '本体更新', years: 5, label: '井戸ポンプメンテ', searchKey: '井戸メンテ', suffix: 'MAINT-WELL-5Y' },
